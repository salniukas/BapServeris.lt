  ...
  <div class="content">
    <div class="container-fluid">
      <div class="row d-flex justify-content-center">
        <div class="col-md-8">
          <form method="post" action="{{ route('blog-update') }}" autocomplete="off" class="form-horizontal" id="prof">
            @csrf
            @method('POST')
            ...
            <div class="card ">
              ...
              <div class="card-body ">
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                      <input class="form-control" name="title" id="title" type="text" value="{{$blog->title}}" placeholder="Kada Adminas?" required/>
                ...
                <div class="row">
                  ...
                  <div class="col-sm-6">
                    <div class="form-group">
                        <textarea class="form-control" rows="10" name="content" id="content" type="text" value="" placeholder="Pranešimas" required>{{$blog->content}}</textarea>
                    </div>
                  </div>
                </div>
